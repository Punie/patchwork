...
/**********************************************************************/
/* fill_quarter_circle_est : remplit un quart de cercle               */

void fill_quarter_circle_est(Fenetre f, int x, int y, int R) {

   StructFenetre *fenetre = (StructFenetre *)f;

   XFillArc(Moniteur, (Drawable)fenetre->buffer, fenetre->gc,
            x - R, y - R, 2 * R, 2 * R, 0, 5760);
   rafraichirFenetre(fenetre);
}

/**********************************************************************/
/* fill_quarter_circle_nord : remplit un quart de cercle              */

void fill_quarter_circle_nord(Fenetre f, int x, int y, int R) {

   StructFenetre *fenetre = (StructFenetre *)f;

   XFillArc(Moniteur, (Drawable)fenetre->buffer, fenetre->gc,
            x - R, y - R, 2 * R, 2 * R, 5760, 5760);
   rafraichirFenetre(fenetre);
}

/**********************************************************************/
/* fill_quarter_circle_ouest : remplit un quart de cercle             */

void fill_quarter_circle_ouest(Fenetre f, int x, int y, int R) {

   StructFenetre *fenetre = (StructFenetre *)f;

   XFillArc(Moniteur, (Drawable)fenetre->buffer, fenetre->gc,
            x - R, y - R, 2 * R, 2 * R, 11520, 5760);
   rafraichirFenetre(fenetre);
}

/**********************************************************************/
/* fill_quarter_circle_sud : remplit un quart de cercle               */

void fill_quarter_circle_sud(Fenetre f, int x, int y, int R) {

   StructFenetre *fenetre = (StructFenetre *)f;

   XFillArc(Moniteur, (Drawable)fenetre->buffer, fenetre->gc,
            x - R, y - R, 2 * R, 2 * R, 17280, 5760);
   rafraichirFenetre(fenetre);
}
